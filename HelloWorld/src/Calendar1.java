...
public class Calendar1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//WebElement monthTitle = driver.findElement(By.xpath("//td[@class='monthTitle']"));
		//WebElement calendarNextButton = driver.findElement(By.xpath("//button[normalize-space()='>']"));
		while(!driver.findElement(By.xpath("//td[@class='monthTitle']")).getText().contains("Apr"))
		{
